                           ...
                           try
						      	 {
												 							                          	...
												 							                          	Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
												 										con = DriverManager.getConnection("jdbc:odbc:travel","","");
												 String sel1=t1.getText();

				stmt.executeUpdate("UPDATE customer SET  idProof='" +t2.getText()
                +"', number='"+t3.getText()
				+"', name='"+t4.getText()
			    +"', gender='"+t5.getText()
				+"', country='"+t6.getText()
...
System.out.println("hello");
												 							   				...
												 							   				JOptionPane.showMessageDialog(null,"Changes in the record has been successfully save.","ArmyBaseManagementSystem",JOptionPane.INFORMATION_MESSAGE);
												 											dispose();
		...
		JButton btnExit = new JButton("Search");
...
JButton btnExit1 = new JButton("Back");
		...
		btnExit1.setBounds(420, 430, 120, 30);
